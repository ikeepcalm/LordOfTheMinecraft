...
public class RecipeWrapper extends AbstractItem {
    ...
    public RecipeWrapper(Advertiser advertiser, AdvertiserManager advertiserManager, int pathway, int sequence) {
    ...
    public ItemProvider getItemProvider() {
        int basePrice = LordOfTheMinecraft.instance.getConfig().getInt("recipe");
        itemStack = LordOfTheMinecraft.instance.getRecipe().getRecipeForSequence(LordOfTheMinecraft.instance.getPotions().get(pathway), sequence);
